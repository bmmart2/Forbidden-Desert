...
public class Tile {
    ...
    private static final Image stormImg = new Image(Thread.currentThread().getContextClassLoader().getResource("assets/storm.jpg").toString());
    ...
    protected Tile(Location l) {
        ...
        else if (l.getType() == LocationType.STORM)
            backImg = stormImg;
    }
